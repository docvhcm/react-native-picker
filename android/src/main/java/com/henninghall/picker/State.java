...
import com.henninghall.picker.models.Is24HourSource;
...
import com.henninghall.picker.props.Prop;
...
public class State {
    ...
    public ReadableArray getItems() {
      return (ReadableArray) itemsProp.getValue();
    }
