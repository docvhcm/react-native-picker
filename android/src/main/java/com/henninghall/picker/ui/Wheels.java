package com.henninghall.picker.ui;

import android.view.View;

import com.henninghall.picker.models.Variant;
import com.henninghall.picker.pickers.Picker;
import com.henninghall.picker.R;
import com.henninghall.picker.State;
import com.henninghall.picker.models.WheelType;
import com.henninghall.picker.models.Mode;
import com.henninghall.picker.wheelFunctions.SetDividerHeight;
import com.henninghall.picker.wheelFunctions.SetShowCount;
import com.henninghall.picker.wheelFunctions.WheelFunction;
import com.henninghall.picker.wheels.AmPmWheel;
import com.henninghall.picker.wheels.DateWheel;
import com.henninghall.picker.wheels.DayWheel;
import com.henninghall.picker.wheels.HourWheel;
import com.henninghall.picker.wheels.MinutesWheel;
import com.henninghall.picker.wheels.MonthWheel;
import com.henninghall.picker.wheels.Wheel;
import com.henninghall.picker.wheels.YearWheel;
import com.henninghall.picker.wheels.ArrayWheel;
...
public class Wheels {
    ...
    Wheels(State state, View rootView){
        ...
        arrayWheel = new ArrayWheel(getPickerWithId(R.id.array), state);
    ...
    private HashMap<WheelType, Wheel> getWheelPerType(){
        return new HashMap<WheelType, Wheel>() {{
            ...
            put(WheelType.ARRAY, arrayWheel);
        }};
    }
